...
public class AgentAttacher {
    private final static String DEFAULT_JAR_NAME = "redefine.jar";
    ...
    public static void main(String[] args) {
        try {
            ...
            // 获取Agent JAR路径
            String agentPath = getAgentJarPath(null);
            ...
            vm.loadAgent(agentPath, "type=hotfix,dir=hotfix");
     ...
     * 获取Agent JAR路径
     */
    private static String getAgentJarPath(String jarName) {
        if (jarName == null) {
        ...
        try {
            ...
            // 如果都不存在，使用完整路径
            return new File("advance/instruments/target/" + jarName).getAbsolutePath();
